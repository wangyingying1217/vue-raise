<template>
  <div class="raise-wrapper">
    <div v-show="$route.path !== '/ModifyRaise/search'">
      ...
      <div class="submit-wrapper">
        <input v-if="modifyType !== 'return'" class="submit act w6 mr2" type="button" value="上一步" @click="state.name = 'describe'">
...
export default {
  ...
  methods: {
    choose: function (item, value) {
      ...
      this.$router.push('/ModifyRaise/search')
    },
